...
class TodoServiceStub(object):
    ...
    def __init__(self, channel):
        ...
        self.ListTodos = channel.unary_unary(
                ...
                response_deserializer=todo__pb2.TodosResponse.FromString,
                _registered_method=True)
...
def add_TodoServiceServicer_to_server(servicer, server):
    rpc_method_handlers = {
            ...
            'ListTodos': grpc.unary_unary_rpc_method_handler(
                    ...
                    response_serializer=todo__pb2.TodosResponse.SerializeToString,
            ),
    }
...
class TodoService(object):
    ...
    def ListTodos(request,
        ...
        return grpc.experimental.unary_unary(
            ...
            todo__pb2.TodosResponse.FromString,
            options,
            channel_credentials,
            insecure,
            call_credentials,
